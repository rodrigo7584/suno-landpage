...
function showData() {
  ...
  const fieldMappings = [
    ...
    { name: 'instalacao-0', displayName: 'Instalação opção 1:' },
    { name: 'instalacao-1', displayName: 'Instalação opção 2:' },
    { name: 'instalacao-2', displayName: 'Instalação opção 3:' }
  ]
  ...
  for (const [name, value] of formData.entries()) {
    ...
    if (field) {
      ...
      sessionStorage.setItem(field.displayName, value)
